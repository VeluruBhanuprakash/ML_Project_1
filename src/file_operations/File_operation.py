...
class File_Operation:
    ...
    def __init__(self,file_object,logger_object):
        ...
        self.model_directory='src/models/'

    def save_model(self,model,filename):
        self.logger_object.logger(self.file_object, 'Entered the save_model method of the File_Operation class')
        try:
            ...
            self.logger_object.logger(self.file_object,'Exception occured in save_model method of the Model_Finder class. Exception message:  ' + str(e))
            self.logger_object.logger(self.file_object,
    ...
    def load_model(self,filename):
        ...
        self.logger_object.logger(self.file_object, 'Entered the load_model method of the File_Operation class')
        try:
    ...
    def find_correct_model_file(self,cluster_number):
        self.logger_object.logger(self.file_object, 'Entered the find_correct_model_file method of the File_Operation class')
        try:
